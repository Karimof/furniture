...
describe('Type Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'type', component: TypeComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to typeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTypeIdentifier).toHaveBeenCalledWith(entity);
