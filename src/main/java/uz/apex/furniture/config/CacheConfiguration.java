package uz.apex.furniture.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, uz.apex.furniture.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, uz.apex.furniture.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, uz.apex.furniture.domain.Type.class.getName());
